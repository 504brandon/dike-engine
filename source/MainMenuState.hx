...
class MainMenuState extends MusicBeatState
{
	...
	#if !switch
	var optionShit:Array<String> = ['story mode', 'freeplay', 'donate', 'options', 'credit'];
	#else
	...
	override function create()
	{
		...
		menuItems.createItem(0, 0, "credit", function()
			{
				startExitState(new credits.CreditState());
			});
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "v" + CoolUtil.coolTextFile(Paths.txt('version')), 12);
