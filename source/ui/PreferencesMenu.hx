...
class PreferencesMenu extends Page
{
	...
	override public function new()
	{
		...
		createPrefItem('original imput', 'ogi', false);
		createPrefItem('downscroll', 'downscroll', false);
		createPrefItem('note splashes', 'ns', true);
		createPrefItem('no watermarks', 'nwm', false);
		createPrefItem('flashing menu', 'flashing-menu', true);
		createPrefItem('Camera Zooming on Beat', 'camera-zoom', true);
		createPrefItem('no icon colors', 'nohealthcolors', false);
		createPrefItem('FPS Counter', 'fps-counter', true);
		createPrefItem('Auto Pause', 'auto-pause', false);
		createPrefItem('healthdrain', 'hpd', false);
	...
	public static function initPrefs()
	{
		...
		preferenceCheck('nwm', false);
		preferenceCheck('flashing-menu', true);
		preferenceCheck('camera-zoom', true);
		preferenceCheck('fps-counter', true);
		preferenceCheck('nohealthcolors', false);
		preferenceCheck('ogi', false);
